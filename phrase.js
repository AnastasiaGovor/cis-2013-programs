...
else
{
    ...
    {
        if(stringEntry.charAt(intCount)==="A" || stringEntry.charAt(intCount)==="E" || stringEntry.charAt(intCount)==="I" || stringEntry.charAt(intCount)==="O" || stringEntry.charAt(intCount)==="U"|| stringEntry.charAt(intCount)==="Y" )
        {
            intVowels++;
        }
    }
    $("output").value = "there are " + intVowels + " vowels in the phrase you used";
}
};
